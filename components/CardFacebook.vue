...
const postURL = computed(() => `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(props.url)}`);
...
<template>
  <CardGeneric title="Facebook" :state="state" :body="announcement">
    ...
    <a :href="postURL" class="btn btn-primary" @click.prevent="post"> Copy Announcement and Post </a>
  </CardGeneric>
</template>
